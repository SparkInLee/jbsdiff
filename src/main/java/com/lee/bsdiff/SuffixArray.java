 ...
 * suffix array
 * 
 * @see http://www.larsson.dogma.net/ssrev-tr.pdf
 * 
 * @author jianglee
 * 
 */
public class SuffixArray {
	private static final String TAG = "SuffixArray";

	private File file = null;

	private int[] I = null;

	public SuffixArray(File file) {
		this.file = file;
	}
	 ...
	 * @param start
	 * @param end
	 * @return {@link TwoTuple<T,R>}, t is start position and r is length.
	 */
